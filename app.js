...
var fade = -1;
var opacity = 0.9;
myMusic=new sound("sounds/happy-pop-2-185287.mp3")

function startGame() 
{
    floor = new component(960, 60, "images/floor.png", 0, 587, "image");
    myGamePiece = new component(50, 37, "images/Layer_1.png", 200, 300, "image");
    myGamePiece.gravity = 0.2;
    myScore = new component("40px", "Flappybird", "black", 130, -20, "text");
    myGameArea.start();
    mySound= new sound("sounds/we.mp3");
...
function updateGameArea() {
    if (gameRunning)
    {
        ...
        myGamePiece.newPos();
        myGamePiece.image.src = `images/Layer_${Math.ceil(time) % 8 + 1}.png`;
        myGamePiece.update();
        if (myGameArea.frameNo == 1 || everyinterval(100)) {
            ...
            myObstacles.push(new component(90, 630, "images/mario_pipe_inverted.png", x, height - 630, "image"));
            myObstacles.push(new component(90, 630, "images/mario_pipe_normal.png", x, height + gap, "image"));
        }
        for (i = 0; i < myObstacles.length; i++) {
            myObstacles[i].x -= 3;
            myObstacles[i].update();
